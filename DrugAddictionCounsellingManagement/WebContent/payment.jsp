...
<body>
					...
					<div class="row">
							...
							<div class="row">
								<div class="col-50">
									<label for="state">State</label> <input type="text" id="state"
										name="state" placeholder="NY" required="required">
								</div>
								<div class="col-50">
									<label for="zip">Zip</label> <input type="text" id="zip"
										name="zip" placeholder="10001" required="required">
								</div>
							</div>
						</div>
						...
						<div class="col-50">
							...
							<label for="cname">Name on Card</label> <input type="text"
								...
								required="required"> <label for="ccnum">Credit
								card number</label> <input type="text" id="ccnum" name="cardnumber"
								placeholder="1111-2222-3333-4444" required="required"> <label
							...
							<div class="row">
								...
								<div class="col-50">
									<label for="cvv">CVV</label> <input type="text" id="cvv"
										name="cvv" placeholder="352" required="required">
								</div>
							</div>
						</div>
	...
	<%
		...
		if (pid != null) {
			...
			Schedule schedule = HibernateDAO.getScheduleById(Integer.parseInt(pid));
			schedule.setPaymentstatus("yes");

			if (HibernateTemplate.updateObject(schedule) == 1) {
